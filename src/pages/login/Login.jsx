...
const Login = () => {
    ...
    const handleLogin = async (data) => {
        ...
        try {
            // Enviamos el rol en minusculas al backend para evitar errores de credenciales
            ...
            // --- VALIDACION ESTRICTA (SIN MAYUSCULAS NI ACENTOS) ---
            const rolSeleccionado = data.rol.toLowerCase().trim();
            const rolRealBD = rol.toLowerCase().trim();

            if (rolSeleccionado !== rolRealBD) {
            ...
            // Si el rol coincide, guardamos sesion
            setToken(token);
            setRol(rol);
            ...
            <div className="login-container">
                ...
                <div className="login-card">
                    ...
                    <form className="login-form" onSubmit={handleSubmit(handleLogin)}>
                        ...
                        <Link to="/Forgot-password" id="forgot">¿Olvidaste tu contraseña?</Link>
                    </form>
